...
typedef enum SAArchiveFormat {
    ...
    SA_ARCHIVE_FORMAT_TAR = 3,
    SA_ARCHIVE_FORMAT_GZIP = 4,
    SA_ARCHIVE_FORMAT_7ZIP = 5,
    SA_ARCHIVE_FORMAT_BZIP2 = 6,
    SA_ARCHIVE_FORMAT_XZ = 7,
    SA_ARCHIVE_FORMAT_LZMA = 8,
    SA_ARCHIVE_FORMAT_LZIP = 9,
    SA_ARCHIVE_FORMAT_COMPRESS = 10,
    SA_ARCHIVE_FORMAT_ZSTD = 11,
    SA_ARCHIVE_FORMAT_LZ4 = 12,
    SA_ARCHIVE_FORMAT_CAB = 13,
    SA_ARCHIVE_FORMAT_CPIO = 14,
    SA_ARCHIVE_FORMAT_ISO9660 = 15,
    SA_ARCHIVE_FORMAT_LHA = 16,
    SA_ARCHIVE_FORMAT_AR = 17,
    SA_ARCHIVE_FORMAT_WARC = 18,
} SAArchiveFormat;
